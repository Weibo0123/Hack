import sys
import subprocess
from creat_machine import create_machine
...
def start_game(num_players):
    try:
        ...
        run("docker run -dit --name hack-server --network hacknet hack-server -p 5000:5000 -v /var/run/docker.sock:/var/run/docker.sock hack-server")
